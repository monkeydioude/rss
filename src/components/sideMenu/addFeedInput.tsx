...
import { add_feed_source } from "../../services/feed_builder";
// import { FeedsContext } from "src/context/feedsContext";
import { addChannel, useDispatch } from "src/states/channels";
    ...
    <View>
      <TextInput
        onSubmitEditing={async (event: NativeSyntheticEvent<TextInputSubmitEditingEventData>) => {
          ...
          if (channel_id !== null) {
            dispatch(addChannel([channel_id, event.nativeEvent.text]));
          }
